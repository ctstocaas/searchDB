...
1.	Place this jk.conf file to /etc/apache2/mods-available directory:

 
2.	Place this workers.properties file to /etc/apache2/mods-available/workers.properties directory:
 
Edit this property worker.router.host=192.0.1.6 in the file to IP address of the Tomcat server
3.	Place this 000-default.conf file to /etc/apache2/sites-enabled/000-default.conf directory:
...
Download the latest application war file from github: https://github.com/ctstocaas/searchDB
Rename the war file to SearchDB.war
Place the file in <tomcat-installation-directory>/webapp
...
Note: This application will not work until MqSQL server is up and running and the IP address of the MySQL server is updated in the application configuration file. Install and configure MySQL server according to following section.
